...
-- Inserindo Dados
INSERT IGNORE INTO clientes (nome_cliente, email_cliente) VALUES ('Paulin', 'paulinbacana123faavela@gmail.com'), ('Jorge', 'jorgequebrada@gmail.com'), 
                     ('João', 'jaozingameplay@gmail.com'), ('Arthur', 'tutuproducoes@gmail.com'), ('tyler', 'tylerthecreator@gmail.com');
INSERT IGNORE INTO produtos (nome_produto, preco) VALUES ('Teclado', '120.00'), ('Mouse', '90.00'), ('Fone', '60.00');
INSERT IGNORE INTO venda (cliente_comprou, data_venda) VALUES (1, '2026-02-10'), (2, '2026-02-11'), (3, '2036-02-12'), (4, '2040-12-12'),
                  (5, '2080-12-31');
INSERT IGNORE INTO item_venda (id_item_venda, id_item_produto, qtd, preco_unit) VALUES (1, 1, 2, '120.00'), (2, 2, 1, '90.00'), (3, 3, 2, '60.00'), 
